...
def plot_voronoi_edges_3d(vor, highlight_point_index):
    ...
    ax.set_xlim(vor.points[highlight_point_index,0] - 5, vor.points[highlight_point_index,0] + 5)
    ax.set_ylim(vor.points[highlight_point_index,1] - 5, vor.points[highlight_point_index,1] + 5)
    ax.set_zlim(vor.points[highlight_point_index,2] - 5, vor.points[highlight_point_index,2] + 5)
